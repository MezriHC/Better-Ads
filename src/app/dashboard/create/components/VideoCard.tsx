...
export function VideoCard({ video, onPlay, onDownload, onDelete, onRename }: VideoCardProps) {
  ...
  return (
    <div className="bg-card border border-border rounded-2xl overflow-hidden group">
      {/* Thumbnail Container - Toujours carré */}
      <div className="relative aspect-square bg-muted overflow-hidden">
        ...
        {/* Status Overlay pour processing et failed */}
        {isProcessing && (
        ...
        {/* Play Button - Style exact du dashboard */}
        {isReady && (
      ...
      {/* Bottom section with tags - Style AvatarSlider */}
      <div className="p-3">
