...
export function AudioSettingsDrawer({
  ...
  return (
    <div className="flex flex-col gap-4 transition-all duration-400 ease-in-out h-full">
      ...
      <button
        ...
        className="w-full flex items-center justify-between p-3 bg-muted border border-border rounded-lg hover:bg-accent transition-colors cursor-pointer"
      >
