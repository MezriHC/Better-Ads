...
export default function VideoAvatarPage() {
  ...
  const [currentStep, setCurrentStep] = useState(1) // Step 1: Avatar Selection, Step 2: Script & Audio, Step 3: Video Generation
  ...
  const handleNextStep = () => {
    if (selectedAvatar && currentStep < 3) {
  ...
  const handleStepClick = (step: number) => {
    ...
    // Permettre d'aller en avant seulement si un avatar est sélectionné
    if (step <= currentStep || (selectedAvatar && step <= 3)) {
      setCurrentStep(step)
    }
  }
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        <SectionHeader
          ...
          description="Follow the steps to create your personalized video with an AI avatar."
        />
        ...
        <div className="flex items-center gap-4">
          ...
          <div 
            ...
            <span className="text-sm font-medium">Script & Audio</span>
          </div>
